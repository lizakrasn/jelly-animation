...
},{}],"js/ball.js":[function(require,module,exports) {
"use strict";
...
var Ball = /*#__PURE__*/function () {
  ...
  _createClass(Ball, [{
    ...
    value: function think(mouse) {
      ...
      var dist = Math.sqrt(dx * dx + dy * dy); //interection

      if (dist < 30) {
        var angle = Math.atan2(dy, dx);
        var tx = mouse.x + Math.cos(angle) * 50;
        var ty = mouse.y + Math.sin(angle) * 50;
        this.vx += tx - this.x;
        this.vy += ty - this.y;
      } //spring back
      ...
      this.vy += dy1 * this.springFactor; //friction

      this.vx *= this.friction;
      this.vy *= this.friction; //actual move
...
var pos = new _mouse.default(canvas);
var balls = [];
var mouse = new _ball.default(0, 0, 30, "yellow");

for (var i = 0; i < 50; i++) {
  balls.push(new _ball.default(200 + 100 * Math.cos(i * 2 * Math.PI / 50), 200 + 100 * Math.sin(i * 2 * Math.PI / 50)));
}
...
function Render() {
  ...
  mouse.draw(ctx);
  balls.forEach(function (ball) {
    ball.think(pos); // ball.draw(ctx);
  });
  ConnectDots1(balls);
}

Render();
},{"./mouse.js":"js/mouse.js","./ball.js":"js/ball.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
